...
public class DetailActivity extends BaseActivity implements UILoader.OnRetryClickListener, DetailListAdapter.ItemClickListener, IAlbumDetailViewCallback, IPlayerCallback {
